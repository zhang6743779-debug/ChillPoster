...
MEDIA_LIBRARY_CACHE_DB_FILE = os.path.join(CONFIG_DIR, "media_library_cache.db")
APP_CACHE_DB_FILE = os.path.join(CONFIG_DIR, "app_cache.db")
TMDB_CACHE_DB_FILE = os.path.join(CONFIG_DIR, "tmdb_cache.db")
