...
createApp({
    ...
    setup() {
        ...
        return {
            ...
            refreshDockerManager, setDockerContainerFilter, runDockerContainerAction, toggleDockerAutoUpdate, openDockerAutoRestartDialog, closeDockerAutoRestartDialog, saveDockerAutoRestartDialog, disableDockerAutoRestart, openDockerLogs, closeDockerLogs, pullDockerImage, deleteDockerImage, pruneUnusedDockerImages, pruneUntaggedDockerImages, setDockerImageFilter,
            closeDockerUpdateDialog, openDockerVersionDialog, closeDockerVersionDialog, saveDockerVersionDialog,
            formatDockerBytes, formatDockerDate, dockerAutoRestartLabel, isDockerImageUntagged, dockerImageTagLabel,
            ...
            cloud115Form, cloud115SourceBrowser, cloud115TargetBrowser, cloud115Transfer,
            ...
            missingEpisodeStats, missingEpisodeLibraries, missingEpisodeActiveLibrary, missingEpisodeActiveSummary, missingEpisodeActiveErrorCount, missingEpisodeActionableMissingCount, missingEpisodeActionableEpisodeCount, moviePilotMissingFillMode, moviePilotMissingFillModeLabel, toggleMoviePilotMissingFillMode, missingEpisodeSearchActive, missingEpisodeStatsProblemItems,
            visibleMissingEpisodeStatsProblemItems, missingEpisodeHasMoreVisibleItems, missingEpisodePosterGridRef, missingEpisodeLoadMoreSentinel, getMissingEpisodePosterKey, getMissingEpisodePosterCategoryLabel, getMovieCollectionCompareMovies, getSelectedMovieCollectionMovie, selectMovieCollectionMovie, isSelectedMovieCollectionMovie, isMovieCollectionRow, isMovieCollectionMissingRow, isMovieCollectionCompleteRow, isMissingEpisodeErrorRow, shouldShowMissingEpisodeTmdbCompare, isMissingEpisodeManualComplete, isMissingEpisodeManualCompleteUpdating, isMissingEpisodePosterReady, countLocalEpisodes, formatLocalSeasonBrief, getLocalSeasonRows, getTmdbSeasonRows, formatEpisodeNumber, isEpisodeListed, openMissingEpisodeCard, toggleMissingEpisodeManualComplete, openMissingEpisodeCompareDetail, openMissingEpisodeResourceSearch, openMissingEpisodeMpSubscribe, openMovieCollectionSelectedDetail, openMovieCollectionSelectedResourceSearch, openMovieCollectionSelectedMpSubscribe, closeMpSubscribeModal, confirmMpSubscribe, toggleMpSubscribeSeason, openDetailMpSubscribe, canOpenMissingEpisodeEmby, getMissingEpisodeEmbyUrl, openMissingEpisodeEmby, canOpenMovieCollectionSelectedEmby, openMovieCollectionSelectedEmby, closeMissingEpisodeCompare,
            ...
            subscribeMedia, unsubscribeMedia, getImdbLink, getTmdbLink, getTvdbLink,
            ...
            resourceSearchSortButtonText,
            resourceSearchSourceReady, resourceSearchGroups, resourceSearchActiveGroup, resourceSearchActiveItems,
            resourceSearchFilteredItems, resourceSearchFilterOptions, resourceSearchHasFilters,
            setResourceSearchActiveSource, clearResourceSearchFilters, resourceSearchItemKey, resourceSearchItemTags,
            resourceSearchItemClass, resourceSearchCanPreview, resourceSearchCanTransfer,
            resourceSearchCanAddDownloader,
            toggleResourceSearchSortMenu, closeResourceSearchSortMenu, setResourceSearchSortDirection, setResourceSearchSortField,
            toggleResourceSearchSourceMenu, closeResourceSearchSourceMenu,
            toggleResourceSearchSource, loadResourceSearchSources,
            resourceSearchModal, openDetailResourceSearch, closeResourceSearchModal, openForwardResource, addMoviePilotResourceToDownloader, previewForwardResource,
            genreList,
            ...
            runOrganize, runCollectionBackfill, cancelOrganize,
            ...
            embyCacheRefreshing, embyScraperSyncing, refreshEmbyCache,
