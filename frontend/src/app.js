...
createApp({
    ...
    setup() {
        ...
        return {
            ...
            refreshDockerManager, runDockerContainerAction, toggleDockerAutoUpdate, openDockerScheduledRestartDialog, closeDockerScheduledRestartDialog, saveDockerScheduledRestartDialog, disableDockerScheduledRestart, openDockerLogs, closeDockerLogs, pullDockerImage, deleteDockerImage, pruneUnusedDockerImages, pruneUntaggedDockerImages, setDockerImageFilter,
